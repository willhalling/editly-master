...
const Editly = async (config = {}) => {
  ...
  // console.log('getTransitionToClipId', getTransitionToClipId());
  // console.log('getTransitionFromClip', getTransitionFromClip());
  // console.log('getTransitionToClip', getTransitionToClip());
  ...
  try {
    ...
    while (true) {
      ...
      /*
      console.log('fromClipNumFrames', fromClipNumFrames);
      console.log('toClipNumFrames', toClipNumFrames);
      console.log('fromClipProgress', fromClipProgress);
      console.log('toClipProgress', toClipProgress);
      console.log('fromClipTime', fromClipTime);
      console.log('toClipTime', toClipTime); */
